...
class CalendarFragment : BaseFragment<FragmentCalendarBinding>(R.layout.fragment_calendar) {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val routeList = arrayListOf(
            ...
            Route(10,0,3,10,"2022-10-23",1, "11.완전 가을날씨.. 한강에서 피크닉", '0', '0'),
            Route(11,0,3,11,"2022-10-23",1, "12.밥먹고 배불러서 연남동 산책", '0', '0'),
            Route(12,0,3,12,"2022-10-23",1, "13.홍대, 망원, 연남, 연희 소품샵 구경", '0', '0'),
            Route(13,0,3,13,"2022-10-23",1, "14.아이폰사러 성북구 갔다온날", '0', '0'),
            Route(14,0,3,14,"2022-10-23",1, "15.오늘은 알찬 하루~~", '0', '0'),
            Route(15,0,3,15,"2022-10-23",1, "16.남이섬 당일치기!!!!! 춘천까지 다녀옴", '0', '0'),
            Route(16,0,3,16,"2022-10-23",1, "17.대전 성심당 다 돌기", '0', '0'),
