...
class MainActivity : BaseActivity<ActivityMainBinding>(R.layout.activity_main) {
    ...
    private fun setBottomNavigation() {
        ...
        navController.addOnDestinationChangedListener { _, destination, _ ->
            when (destination.id) {
                R.id.addRouteFragment, R.id.routeFragment, R.id.editUserFragment, R.id.editCoupleStartDateFragment, R.id.settingsFragment, R.id.editRouteFragment, R.id.routeBottomSheet -> {
